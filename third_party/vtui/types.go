...
// PeriodicRedrawRenderer lets a renderer opt out of the terminal-oriented
// heartbeat used for cursor blinking and animations. Renderers which do not
// implement this interface retain the historical periodic redraw behavior.
// Event-driven native hosts typically animate their own cursor and should
// return false so an otherwise idle application remains asleep.
