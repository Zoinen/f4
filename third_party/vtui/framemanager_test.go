...
func (*periodicRedrawTestRenderer) SetPalette(*[256]uint32)                       {}
...
func (*defaultRedrawTestRenderer) Render([]CharInfo, []CharInfo, int, int, bool) {}
func (*defaultRedrawTestRenderer) SetCursor(int, int, bool, CursorShape)         {}
func (*defaultRedrawTestRenderer) SetPalette(*[256]uint32)                       {}
...
func TestPeriodicRedrawRendererCapability(t *testing.T) {
	...
	if !rendererWantsPeriodicRedraw(&periodicRedrawTestRenderer{wants: true}) {
		t.Fatal("renderer requesting periodic redraws was disabled")
	}
