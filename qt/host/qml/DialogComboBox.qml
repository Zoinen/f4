...
F4ComboBox {
    ...
    // only a projection.  Reflect that distinction to the native control's
    // cursor presentation without enabling the Qt template's own editable
    // popup/content lifecycle.
    textEditable: widget.dropdownOnly !== true
