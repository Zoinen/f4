...
T.CheckBox {
    ...
    indicator: Rectangle {
        ...
        Rectangle {
            ...
            width: control.tristate && control.checkState === Qt.PartiallyChecked
                   ? control.snap(9) : control.snap(6)
            height: control.tristate && control.checkState === Qt.PartiallyChecked
                    ? control.snap(2) : control.snap(6)
