...
Item {
    ...
    Copy { id: decoderHeading; identity: "galleryDecodersTitle"; x: 0; y: animation.y + animation.height + page.gap * 2; width: page.innerWidth; text: qsTr("Image decoders"); font.bold: true; font.pixelSize: 13 }
