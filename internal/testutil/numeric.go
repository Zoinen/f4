...
func Uint32Rune(value rune) uint32 {
	if value < 0 {
...
func Uint64Rune(value rune) uint64 {
	if value < 0 {
		panic("test character is negative")
	}
...
func ByteInt64(value int64) byte {
	if value < 0 || value > math.MaxUint8 {
...
func Int64Uint64(value uint64) int64 {
...
func Int64Uint(value uint) int64 {
