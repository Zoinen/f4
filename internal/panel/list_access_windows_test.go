...
// denyPanelDirectoryListing adds an explicit deny ACE for Everyone (S-1-1-0)
// on the "read data/list directory" right (RD) of dir alone. Reading its
// attributes stays allowed, so Stat keeps working while opening it for
// listing is refused.
