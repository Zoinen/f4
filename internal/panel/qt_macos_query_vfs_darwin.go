...
type macOSQueryVFS struct {
	...
	title     string
	parent    vfs.VFS
	client    plughost.PlatformServices
...
func newMacOSQueryVFS(uri, kind, tag, title string, parent vfs.VFS) *macOSQueryVFS {
	return &macOSQueryVFS{
		...
		client: plughost.CurrentPlatformServices(), entries: make(map[string]*macOSQueryEntry),
	}
}
...
func (q *macOSQueryVFS) ReadDir(
	...
	if q.client == nil || !q.client.Available() {
		return plughost.ErrPlatformServicesUnavailable
	}
	...
	err := q.client.Request(readCtx, "macos.query", payload, func(response plughost.PlatformResponse) error {
...
func (q *macOSQueryVFS) WatchDirectory(
	...
	return q.client.Request(watchCtx, "macos.watch", payload, func(response plughost.PlatformResponse) error {
...
func (q *macOSQueryVFS) mountPayload(
	...
	mountPath := ""
	err := q.client.Request(ctx, "macos.mount", payload, func(response plughost.PlatformResponse) error {
		var values []any
