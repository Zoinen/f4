...
func appQuickViewFromLegacy(node map[string]any) extui.QuickViewModel {
	view := extui.QuickViewModel{
		SourcePanelID:     semantic.String(node["sourcePanelId"]),
		EntryID:           semantic.String(node["entryId"]),
		CatalogRevision:   semantic.Int64(node["catalogRevision"]),
		PreviewGeneration: semantic.Int64(node["previewGeneration"]),
		ImageRenderer:     semantic.String(node["imageRenderer"]),
		ID:                semantic.String(node["id"]),
		Side:              semantic.Int(node["side"]),
...
func appTerminalFromLegacy(node map[string]any) extui.TerminalModel {
	term := extui.TerminalModel{
		...
		SelectionActiveStart:  semantic.AppInt64(node["selectionActiveStart"]),
		SelectionActiveOffset: int(semantic.AppInt64(node["selectionActiveOffset"])),
