...
var commandPaletteProcessKeyAudit = map[string]commandPaletteSurfaceAudit{
	...
	"cmd/f4/windows_locations_menu_windows.go:(*shellContextMenu).ProcessKey": {
	...
	"cmd/f4/windows_locations_menu_windows.go:(*windowsLocationsMenu).ProcessKey": {
...
var commandPaletteNewVMenuAudit = map[string]commandPaletteSurfaceAudit{
	...
	"cmd/f4/macos_locations_darwin.go:newMacOSLocationsMenu#1": {
		class: paletteAuditDynamicProvider, rationale: "the macOS host supplies a live, asynchronous snapshot of platform locations and search views",
	},
	...
	"cmd/f4/windows_locations_menu_windows.go:showShellContextMenu#1": {
	...
	"cmd/f4/windows_locations_menu_windows.go:showWindowsLocationsMenu#1": {
