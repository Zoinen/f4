...
func newUTF8EditorPieceTable(f vfs.ReadAtCloser, size int64, prefix []byte, offsets ...int64) (*piecetable.PieceTable, *AsyncBuffer) {
	pt, buf, _ := newUTF8EditorPieceTableContext(context.Background(), f, size, prefix, offsets...)
	return pt, buf
}

func newUTF8EditorPieceTableContext(ctx context.Context, f vfs.ReadAtCloser, size int64, prefix []byte, offsets ...int64) (*piecetable.PieceTable, *AsyncBuffer, error) {
...
func snapshotEditorOpeningEncoding() editorOpeningEncoding {
	return editorOpeningEncoding{
		memoryMap:       AppConfig.EditorMemoryMap,
...
func prepareEditorDocumentWithEncoding(ctx context.Context, v vfs.VFS, path string, f vfs.ReadAtCloser, encoding editorOpeningEncoding) (*preparedEditorDocument, error) {
	...
	if f != nil {
		...
		if cpID == 65001 {
			...
			if pt == nil {
				pt, buf, err = newUTF8EditorPieceTableContext(ctx, f, size, header, dataOffset)
				if err != nil {
					return nil, err
				}
			}
...
func showPreparedEditor(pf *PanelsFrame, v vfs.VFS, path string, prepared *preparedEditorDocument) {
	...
	if prepared.mapped != nil || prepared.buf != nil {
		editor = NewEditorViewIndexedLater(prepared.pt, v, path)
	} else {
