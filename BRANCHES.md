...
(`5c89af913c2d49c23065871d6e88fe5b55763f6c`), списку PR GitHub и локальному
`git worktree list`.
...
| `codex/lunobot2-378-status` | PR #963, слита; remote ref ещё существует |
...
| `codex/lunobot2-967-branches-status` | PR #968, слита; remote ref ещё существует |
| `codex/lunobot2-413-criteria` | PR #970, слита; remote ref ещё существует |
| `codex/branches-audit-after-968` | PR #969, слита; remote ref ещё существует |
...
| Ветка | Состояние |
| --- | --- |
| `codex/lunobot1-978` | текущая работа, PR #982 |

09-09-2026 10:30:23 Лунобот-2 (node a721a6d1487257292ae00780; LNX), ветка `codex/a721a6d1487257292ae00780/lunobot-2/coverage-fusefs-node-fuse` для кастомной задачи «покрыть тестами пакет fusefs/node_fuse» по § 22 п. 3 (часть 1 из 1)
